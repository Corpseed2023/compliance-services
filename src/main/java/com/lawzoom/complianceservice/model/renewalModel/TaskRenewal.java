...
@Getter
@Setter
@Table(name = "task_renewal")
public class TaskRenewal {
    ...
    @Comment(value = "Date when the certificate needs renewal")
    private LocalDate renewalDate;

    @Enumerated(EnumType.STRING)
    @NotNull
    @Comment(value = "Type of duration for reminder (DAYS, WEEKS, MONTHS, YEARS)")
    private Renewal.ReminderDurationType reminderDurationType;
