...
public class MilestoneController {
    ...
    @PostMapping("/create")
    public ResponseEntity<MilestoneResponse> createMilestone(@Valid @RequestBody MilestoneRequest milestoneRequest) {
    ...
    public ResponseEntity<List<MilestoneResponse>> fetchAllMilestones(@Valid @RequestBody MilestoneRequestForFetch request) {
